...
{
    [TestClass]
    public class GpioPinsRev2Test
    {
        private GpioPinsRev2 pins;

        [TestInitialize]
        public void Setup()
        {
            pins = new GpioPinsRev2();
        }
        ...
        {
            Assert.AreEqual<int>(2, pins.IdOfPinNumber(3));
            Assert.AreEqual<int>(3, pins.IdOfPinNumber(5));
            ...
            Assert.AreEqual<int>(27, pins.IdOfPinNumber(13));
